  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppbar(
          context: context,
          text1:
              "Order " + widget.snapshot[widget.index]["custRefNo"].toString(),
          automaticallyImplyLeading: true,
          backgroundColor: CustomColors.customYellow,
          directionVisibility: widget.snapshot[widget.index]["status"] ==
                      "delivered" ||
                  widget.snapshot[widget.index]["status"] ==
                      "delivered-pending" ||
                  widget.snapshot[widget.index]["status"] == "returned-pending"
              ? false
              : true,
          ...
          orderId: widget.snapshot[widget.index]["id"]),
